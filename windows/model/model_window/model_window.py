...
from simulator.simulator import system_solver, lat_long_height_plot
from windows.model.model_window.earth_graph_windows.graph.graph import Grapher
from windows.model.model_window.earth_graph_windows.earth.earth import Earth
from simulator.radar import initialise_radars, get_radar_measurements
from predictor.predictor import Predictor
from debug import dev_mode
...
class SimWidget(QWidget):
    ...
    def __init__(self, stacked_widget, initial_conditions, radar_list):
        ...
        if dev_mode:
            ...
            self.z_sim = []
            self.t = []
            existing_file = os.path.join(root_dir, "simulator/sat_traj.dat")
