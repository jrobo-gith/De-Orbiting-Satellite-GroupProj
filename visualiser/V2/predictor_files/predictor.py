...
from visualiser.V2.simulator_files. sat_tracking import do_conversions, radM2eci
...
class Predictor(QWidget):
    def __init__(self, grapher, state0, dt=50.0):
        super().__init__()
    ...
    def predictor_loop(self, info, update):
        ...
        if info['obs-time'] == 0:
            ...
            init_state = np.append(init_pos, radar_z[3:]).tolist()   # append the rest of radar z to complete the initial state
        ...
        ### at time > 0, start UKF process
            ...
            if update != (0, 0, 0):
                ...
                debug_print("predictor", f"Altitude of measurement: {lat_long_height(radar_z_pos_ECI[0], radar_z_pos_ECI[1], radar_z_pos_ECI[2])[2]}")
