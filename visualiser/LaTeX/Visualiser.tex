...
%\section{GAIT Use}
%The generative AI ChatGPT was used in the making of the visualiser. Most of the prompts were to find documentation / API calls in the PyQt module as the documentation was quite poor and its use saved time searching for the correct function. 
